...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0   fixed-start  bg-gradient-dark" id="sidenav-main"><!--border-radius-xl, ms-3, ,my-3-->
    <div class="sidenav-header">
      <i class="fas fa-times p-3 cursor-pointer text-white opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
      <a class="navbar-brand m-0" href="index.php">
        <img src="./images/btb-logo.png" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 text-white">Inventory Dashboard</span>
      </a>
    </div>
    <p class="text-center text-white">
    <?php
      if (isset($_SESSION["userRecord"])){
        if($_SESSION["userRecord"]["User_level_id"] == 1) {echo 'Administrator';} 
        else{echo $_SESSION["userRecord"]["User_name"];}
      }
    ?>
    </p>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="./views/view.tables.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="./views/view.notifications.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize"># of Users</p>
                <h4 class="mb-0"><?php echo returnCountAllUsers($conn); ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><a href="./views/view.tables.php#user-table"><u>See User Table</u></a></p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize"># of Device Types</p>
                <h4 class="mb-0"><?php echo returnCountAllDeviceTypes($conn); ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><a href="./views/view.tables.php#device_types-table"><u>See Device Types</u></a></p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize"># of Registered Devices</p>
                <h4 class="mb-0"><?php echo returnCountAllRegisteredDevices($conn); ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><a href="./views/view.tables.php#registered_devices-table"><u>See All Registered Devices</u></a></p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize"># of Unregistered Devices</p>
                <h4 class="mb-0"><?php echo returnCountAllUnregisteredDevices($conn); ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><a href="./views/view.tables.php#unregistered_devices-table"><u>See All Unregistered Devices</u></a></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3">
        <div class="float-start">
          <h5 class="mt-3 mb-0">UI Color Configurator</h5>
          <p>Edit colors using options below.</p>
        </div>
  ...
  <script src="./includes/js/graph-script.js"></script>
